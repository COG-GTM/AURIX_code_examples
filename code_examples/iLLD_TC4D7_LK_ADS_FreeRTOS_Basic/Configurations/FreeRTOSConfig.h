...
#define configSTM                           ( ( uint32_t * ) (0xF8800000 + configCPU_NR*0x40000 ) )
#define configSTM_SRC                       ( ( uint32_t * ) (0xF4432020 + configCPU_NR*0x40) )
#define configSTM_CLOCK_HZ                  ( 100000000 )
#define configSTM_DEBUG                     ( 1 )
#define configCONTEXT_SRC                   ( ( uint32_t * ) 0xF4433460 )
