 ...
 * IN THE SOFTWARE.
 *********************************************************************************************************************/
 /*\title iLLD_TC4D7_LK_ADS_ICMS_Point_Cloud
 * \abstract This software project for the ICMS board (AURIX TC4D7 and BGT60 ATR24AIP) demonstrates the main radar signal processing steps to generate point cloud data from raw data recorded by the MMIC.
 * \description This software project is intended as a starting point for the application of in cabin monitoring (ICMS). It demonstrates the main processing steps that need to be performed on AURIX TC4D7 signal processing unit (SPU) and Tricore CPUs to generate point cloud data from raw data recorded by the BGT60 ATR24AIP MMIC.
 *              
 *              Basic understanding of FMCW radar range-doppler signal processing is presumed to follow this code example.
 *
 * \name iLLD_TC4D7_LK_ADS_ICMS_Point_Cloud
 * \version V1.0.0
