...
## Hardware setup
This code example has been developed for the board AURIX&trade; TC4D7 lite Kit (KIT_A3G_TC4D7_LITE) and the temperature/humidity sensor module DHT11.

<img src="./Images/KIT_TC4D7_LK_Front.PNG" width="600" /><br />
...
- Open OneEye - it can be opened either by double-clicking on the configuration file which is provided inside the Libraries folder (.../Libraries/iLLD_TC4D7_LK_ADS_DHT11.OneEye) or by clicking on the dedicated button <img src="./Images/oneeye.png" />
