...
boolean randomGeneratorShell(pchar args, void *data, IfxStdIf_DPipe *io)
{
    ...
    for (int i = 0; i<8 ; i++)
    {
      ...
      g_analogueRead = run_TMADC();                        /* Read from analog channel                             */
...
void initSerialInterface(void)
{
    ...
    const IfxAsclin_Asc_Pins pins =
    {
            ...
            .rx         = &IfxAsclin0_RXA_F_P14_1_IN,         /* Select the pin for RX connected to the USB port      */
            .rxMode     = IfxPort_InputMode_pullUp,         /* RX pin                                               */
            .rts        = NULL_PTR,                         /* RTS pin not used                                     */
            .rtsMode    = IfxPort_OutputMode_pushPull,
            .tx         = &IfxAsclin0_TX_F_P14_0_OUT,         /* Select the pin for TX connected to the USB port      */
