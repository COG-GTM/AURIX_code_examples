...
void Mmic_reset(void)
{
    ...
    IfxStm_waitTicks(&MODULE_CPU0, STM0_TICKS_BACKUPCLK_1us);
    ...
    IfxStm_waitTicks(&MODULE_CPU0, STM0_TICKS_BACKUPCLK_10ms);
}
...
void Mmic_enable40MHzClock(void)
{
    ...
    IfxStm_waitTicks(&MODULE_CPU0, STM0_TICKS_BACKUPCLK_20us);

    /*Set resistor value of bandgap filter to 1 MΩ (XOSC_BG_RFILT_SEL = 1) */
    spiCmd[1]  = (0x5F<<25)| (WRITE_MMIC << 24) | 0xF04400;
    Qspi_exchange32(spiCmd[1]);
    IfxStm_waitTicks(&MODULE_CPU0, STM0_TICKS_BACKUPCLK_10us);

    /*Enable XOSC core (XOSC_CORE_EN = 1)*/
    spiCmd[2]  = (0x5F<<25)| (WRITE_MMIC << 24) | 0xF44400;
    Qspi_exchange32(spiCmd[2]);
    IfxStm_waitTicks(&MODULE_CPU0, STM0_TICKS_BACKUPCLK_300us);
    ...
    IfxStm_waitTicks(&MODULE_CPU0, STM0_TICKS_BACKUPCLK_1ms);
}
