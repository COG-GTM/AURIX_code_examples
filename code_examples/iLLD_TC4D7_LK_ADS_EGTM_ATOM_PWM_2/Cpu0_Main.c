 ...
 * IN THE SOFTWARE.
 *********************************************************************************************************************/
 /*\title EGTM ATOM PWM generation
 * \abstract EGTM ATOM is used to generate a PWM signal, which is driving the intensity of an LED.
 ...
 *
 * \name iLLD_TC4D7_LK_ADS_EGTM_ATOM_PWM_2
 * \version V1.0.0
 * \board AURIX TC4D7 lite Kit, KIT_A3G_TC4D7_LITE, TC4D7XP_A-Step_MC_COM
 * \keywords AURIX, EGTM, EGTM_ATOM_PWM_2, PWM, general timer, timer
