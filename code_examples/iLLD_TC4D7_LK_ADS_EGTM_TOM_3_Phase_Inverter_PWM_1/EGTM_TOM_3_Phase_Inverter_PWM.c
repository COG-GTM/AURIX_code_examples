...
#define PHASE_U_HS              &IfxEgtm_TOM0_0_TOUT64_P20_8_OUT      /* TOM0 Ch0, P20.8                            */
#define PHASE_U_LS              &IfxEgtm_TOM0_0N_TOUT65_P20_9_OUT     /* TOM0 Ch0N, P20.9                           */
#define PHASE_V_HS              &IfxEgtm_TOM0_1_TOUT66_P20_10_OUT     /* TOM0 Ch1, P20.10                           */
#define PHASE_V_LS              &IfxEgtm_TOM0_1N_TOUT67_P20_11_OUT    /* TOM0 Ch1N, P20.11                          */
#define PHASE_W_HS              &IfxEgtm_TOM0_2_TOUT68_P20_12_OUT     /* TOM0 Ch2, P20.12                           */
#define PHASE_W_LS              &IfxEgtm_TOM0_2N_TOUT69_P20_13_OUT    /* TOM0 Ch2N, P20.13                          */
...
void initEgtmTom3phInv(void)
{
    ...
    config.clockSource.tom        = IfxEgtm_Cmu_Fxclk_0;                /* Clock source for TOM (FxClk0)             */
    ...
    if(!IfxEgtm_isEnabled(&MODULE_EGTM))
    {
        ...
        /* Enable the FXU clock and CLK0 (TOM needs FXCLK, DTM needs CLK0) */
...
void updateEgtmTom3phInvDuty(void)
{
    if((g_egtmTom3phInv.dutyCycles[0] + PHASE_DUTY_STEP) >= 100)
    {
        g_egtmTom3phInv.dutyCycles[0] = 0;                                /* Set duty to zero                       */
    }
    if((g_egtmTom3phInv.dutyCycles[1] + PHASE_DUTY_STEP) >= 100)
    {
        g_egtmTom3phInv.dutyCycles[1] = 0;                                /* Set duty to zero                       */
    }
    if((g_egtmTom3phInv.dutyCycles[2] + PHASE_DUTY_STEP) >= 100)
    {
        g_egtmTom3phInv.dutyCycles[2] = 0;                                 /* Set duty to zero                      */
    }

    g_egtmTom3phInv.dutyCycles[0] += PHASE_DUTY_STEP;                      /* Increment PWM duty cycle of phase U   */
    g_egtmTom3phInv.dutyCycles[1] += PHASE_DUTY_STEP;                      /* Increment PWM duty cycle of phase V   */
    g_egtmTom3phInv.dutyCycles[2] += PHASE_DUTY_STEP;                      /* Increment PWM duty cycle of phase W   */
