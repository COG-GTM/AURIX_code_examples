...
/* Port definitions for TC4D7 lite kit (S2G1 connector, ASCLIN2) */
#define ASC_HCI_PROTOCOL_CTS_PORT                &MODULE_P23, 4
#define ASC_HCI_PROTOCOL_RTS_PORT                &MODULE_P32, 2
#define ASC_HCI_PROTOCOL_RX_PORT                 &IfxAsclin2_RXC_P02_10_IN
#define ASC_HCI_PROTOCOL_TX_PORT                 &IfxAsclin2_TX_P02_9_OUT
 ...
 */
IFX_INTERRUPT(asc2_tx_ISR, 0, ISR_PRIORITY_ASCLIN_HCI_PROTOCOL_TX);
void asc2_tx_ISR(void)
{
    IfxStdIf_DPipe_onTransmit(&g_asclinPipeHCIProtocol);
}

IFX_INTERRUPT(asc2_rx_ISR, 0, ISR_PRIORITY_ASCLIN_HCI_PROTOCOL_RX);

void asc2_rx_ISR(void)
{
    IfxStdIf_DPipe_onReceive(&g_asclinPipeHCIProtocol);
}

IFX_INTERRUPT(asc2_err_ISR, 0, ISR_PRIORITY_ASCLIN_HCI_PROTOCOL_ER);
void asc2_err_ISR(void)
{
