...
# iLLD_TC4D7_LK_ADS_EGTM_TOM_PWM_2
...
## Scope of work  
The LED is driven by pin 5 of the port 00. The state of the pin is controlled by the PWM signal generated by the Enhanced Generic Timer Module (EGTM) in-built Timer Output Module (TOM).
...
* Configuration of the PWM channel groups to produce PWM signal (EGTM Cluster 1, TOM Channel 4)
...
- The duty cycle of the TOM channel is then updated using the iLLD function *IfxEgtm_Pwm_updateChannelsDutyImmediate()*
