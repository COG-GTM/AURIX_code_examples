 ...
 *              generated by the Enhanced Generic Timer Module (EGTM) in-built Timer Output Module (TOM).
 *
 * \name iLLD_TC4D7_LK_ADS_EGTM_TOM_PWM_2
 * \version V1.0.0
 * \board AURIX TC4D7 lite Kit, KIT_A3G_TC4D7_LITE, TC4D7XP_A-Step_CC_COM
 * \keywords AURIX, EGTM, EGTM_TOM_PWM_2, PWM, general timer, timer
