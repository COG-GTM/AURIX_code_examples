...
/*-----------------------------------------------------Macros--------------------------------------------------------*/
/*********************************************************************************************************************/
#define LED1     LED_1      /* Port pin for LED1 (from board pin.h)   */
#define LED2     LED_2      /* Port pin for LED2 (from board pin.h)   */
#define BUTTON   BUTTON_1   /* Port pin for the button (from board pin.h) */
...
/*********************************************************************************************************************/
/* Function to configure the port pins for the button and LEDs */
void init_GPIOs (void)
{
    /* Set the port pins connected to the LEDs to general output mode push-pull.
...
void control_button (void)
{
     ...
     */
    if ((IfxPort_getPinState(BUTTON.port, BUTTON.pinIndex) == 0) && (g_buttonIsAlreadyPressed == FALSE))
    {
    ...
    else if ((IfxPort_getPinState(BUTTON.port, BUTTON.pinIndex) == 1) && (g_buttonIsAlreadyPressed == TRUE))
    {
...
void control_LED (void)
{
    ...
    else
    {
        ...
        IfxPort_togglePin(LED2.port, LED2.pinIndex);
    }
